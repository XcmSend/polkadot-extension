  ...
  return (
    <>
      ...
      <div className={className}>
        <p>
          {t('You have been redirected because the Beetle Web3 extension believes that this website could compromise the security of your accounts and your tokens.')}
        </p>
